...
namespace Cosmic::CavernConstruction{ ////////////////////////////////////////////////////////////////////////////////////
...
const std::string& Detector::DataName = "cosmic_run";
...
Detector::Detector() : G4VSensitiveDetector("MATHUSLA/MU/Cosmic") {
  collectionName.insert("Cosmic_HC");
...
namespace CMS{
  ...
  constexpr auto earth_total_depth   = 2501.0L*cm;
  ...
  G4LogicalVolume* EarthVolume() {
	...
	auto modified = new G4SubtractionSolid("",
										   ...
										   Construction::Transform(x_displacement,
																   0.5L*y_edge_length + y_displacement,
																   0.5L*(air_gap-CosmicEarth::TotalDepth()) -9.50*m ));
  ...
  long double BaseDepth() {
     return _base_depth - CosmicEarth::TotalShift();
  }
  ...
  G4Translate3D Cavern_Transform(){
    return G4Translate3D(0, 0, -0.5 * CosmicEarth::TotalDepth() + IPDepth);
...
G4VPhysicalVolume* Detector::ConstructEarth(G4LogicalVolume* world){
	...
	using namespace Cosmic::CavernConstruction;
	using namespace Construction;
	using namespace CMS;
	...
	const auto mix_top = CosmicEarth::TotalDepth() - CosmicEarth::MixDepth();
	const auto marl_top = mix_top - CosmicEarth::MarlDepth();
	const auto sandstone_top = marl_top - CosmicEarth::SandstoneDepth();

   	// Construction::PlaceVolume(CMS::_calculate_modification("modified_mix", CosmicEarth::MixVolume(),
	// 						  mix_top + CosmicEarth::MixDepth(), mix_top),
	// 						  earth, CosmicEarth::MixTransform());

  	// Construction::PlaceVolume(CMS::_calculate_modification("modified_marl", CosmicEarth::MarlVolume(),
	// 						  marl_top + CosmicEarth::MarlDepth(), marl_top),
	// 						  earth, CosmicEarth::MarlTransform());


    auto sandstone = CMS::SandstoneVolume();
	// auto sandstone = CMS::_calculate_modification("modified_sandstone", CMS::SandstoneVolume(),
	// 											  sandstone_top + CosmicEarth::SandstoneDepth(), sandstone_top);
	...
	auto modified = Construction::Volume(new G4SubtractionSolid("ModifiedSandstoneCosmic",
																sandstone->GetSolid(),
																Construction::Box("AirBox3", x_edge_length + x_edge_increase, y_edge_length, air_gap),
																Construction::Transform(x_displacement,
																0.5L*y_edge_length + y_displacement,
															    0.5L*(air_gap-CosmicEarth::SandstoneDepth()) - 9.50*m)),
									        	                CosmicEarth::Material::SiO2);

	Construction::PlaceVolume(modified, earth, CosmicEarth::SandstoneTransform());



	//PLACE WHOLE THING IN WORLD
	//auto mod = CMS::_calculate_modification("modified_marl", CosmicEarth::MarlVolume(),
	//                      marl_top + CosmicEarth::MarlDepth(), marl_top);
	...
	return Construction::PlaceVolume(earth, world, CosmicEarth::Transform());
