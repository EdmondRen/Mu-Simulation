...
public:
	...
	static void preDigitizer(GeometryHandler* _geometry); //creates vector of all detIDs in the detector, only needs to be run once to save time
...
private:
	...
	void make_digis(std::vector<double> times, detID id, double _longCenter);//creates the digihits to be added
	std::vector<double> set_hit_location(detID id, double _longCenter); //decides the location of the digihits
	...
	//static functions
	static void layer_detIDs(std::vector<detID>& _detID_list, std::vector<double>& _longCenters); //adds the detIDs in regular horizontal layers
	static void wall_detIDs(std::vector<detID>& _detID_list, std::vector<double>& _longCenters); //adds the detIDs in the vertical wall
	static void floor_detIDs(std::vector<detID>& _detID_list, std::vector<double>& _longCenters); //adds the detIDs in the floor 	
	static void back_detIDs(std::vector<detID>& _detID_list, std::vector<double>& _longCenters); //adds the detIDs in the back wall
